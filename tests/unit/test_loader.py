...
from pmi_analyzer.data.loader import load_historical, append_record, _row_to_metrics
...
class TestLoadHistorical:
    def test_loads_records(self, tmp_path):
        ...
        write_csv(csv_path, [
            {"month": "1402-01", "production": "50.0", "new_orders": "48.0",
             "sales": "", "raw_materials_inv": "", "final_goods_inv": "",
             "input_price": "", "production_expectations": "", "employment": "",
             "exports": "", "delivery_speed": "", "business_activity": "", "pmi_total": "49.0"},
        ])
    ...
    def test_sorts_by_month_ascending(self, tmp_path):
        csv_path = tmp_path / "shamkh.csv"
        write_csv(csv_path, [
            {"month": "1402-03", "production": "46.0", "new_orders": "",
             "sales": "", "raw_materials_inv": "", "final_goods_inv": "",
             "input_price": "", "production_expectations": "", "employment": "",
             "exports": "", "delivery_speed": "", "business_activity": "", "pmi_total": ""},
            {"month": "1402-01", "production": "55.0", "new_orders": "",
             "sales": "", "raw_materials_inv": "", "final_goods_inv": "",
             "input_price": "", "production_expectations": "", "employment": "",
             "exports": "", "delivery_speed": "", "business_activity": "", "pmi_total": ""},
        ])
    ...
    def test_handles_empty_floats(self, tmp_path):
        csv_path = tmp_path / "shamkh.csv"
        write_csv(csv_path, [
            {"month": "1402-01", "production": "", "new_orders": "",
             "sales": "", "raw_materials_inv": "", "final_goods_inv": "",
             "input_price": "", "production_expectations": "", "employment": "",
             "exports": "", "delivery_speed": "", "business_activity": "", "pmi_total": "49.0"},
        ])
...
class TestAppendRecord:
    def test_appends_new_month(self, tmp_path):
        csv_path = tmp_path / "shamkh.csv"
        write_csv(csv_path, [
            {"month": "1402-01", "production": "50.0", "new_orders": "",
             "sales": "", "raw_materials_inv": "", "final_goods_inv": "",
             "input_price": "", "production_expectations": "", "employment": "",
             "exports": "", "delivery_speed": "", "business_activity": "", "pmi_total": "49.0"},
        ])
